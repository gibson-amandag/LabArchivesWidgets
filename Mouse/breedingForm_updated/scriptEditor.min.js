...
widgetData:testData,dams:{1:{}},damNums:[1]}
;return JSON.stringify(output)},
...
this.dams[damNum]={damID:"",damGeneration:"",
breedingNums:[],breedings:{}
},this.makeDamCard(damNum)},
...
;if("edit"===this.mode)$jq351("select.sireBreeding").each((i,e)=>{
$(e)[0].selectize.addOption({value:sireNum,
text:sireID})})},
...
this.updateSireList(sireNum)}),$body},
...
;if("select"===inputType){var selectObj={
...
damBreedings[damBreedingNum]={sireBreeding:null,
breedDate:NaN,breedCage:NaN,breedCageLoc:null,
initialMass:NaN,massNums:[],masses:{},
plugCheckNums:[],plugChecks:{},
sepFromMaleDate:NaN,sepDamCageNum:NaN
...
label:"Delete:",type:"button",
className:"deleteBreeding",optionsObj:[],
addRowClass:"hideView"},{label:"Sire:",
type:"select",className:"sireBreeding",
addRowClass:"updateDamBreedObj",optionsObj:[{
value:"",text:"[Select]"}]},{label:"Date:",
type:"date",className:"breedDate",
addRowClass:"updateDamBreedObj"},{
label:"Cage Num:",type:"number",
className:"breedCage",
addRowClass:"updateDamBreedObj"},{
label:"Cage location:",type:"text",
className:"breedCageLoc",
addRowClass:"updateDamBreedObj"},{
label:"Initial mass:",type:"number",
className:"initialMass",
addRowClass:"updateDamBreedObj"},{
label:"Add plug check:",type:"button",
className:"addPlugCheck"},{label:"Add mass:",
type:"button",className:"addMass"},{
label:"Separated from male:",type:"date",
className:"sepFromMaleDate",
addRowClass:"updateDamBreedObj"},{
label:"Sep cage #:",type:"number",
className:"sepDamCageNum"},{
label:"Parturition Date:",type:"date",
className:"litterDOB"}]
;$cardBody.append($("<div></div>",{
class:"breedDiv","data-breed":damBreedingNum,
"data-dam":damNum}).append($("<hr></hr>")))
...
;if("edit"===this.mode)$jq351(".sireBreeding"+damBreeedingSearch).selectize({})
...
this.updateSireList(sireNum)},upload:function(){
var tableStr=this.addedTable;if(tableStr){
