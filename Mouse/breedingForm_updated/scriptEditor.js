my_widget_script =
{
    ...
    test_data: function () {
        ...
        var output = { 
            widgetData: testData,
            damGenerationNums: [1],
            damGenerations: {1: {damGen: 123, damGenDOB: "2022-11-01", damGenStrain: "CBA"}},
            sireGenerationNums: [2],
            sireGenerations: {2: {sireGen: 234, sireGenDOB: "2022-11-02", sireGenStrain: "GFP2"}}
        };
    ...
    **/
    ...
    makeDamGenList: function(damNum){
        ...
        console.log($(".damGeneration"+damSearch).length);
    ...
    makeSireGenList: function(sireNum){
        ...
        console.log($(".sireGeneration"+sireSearch).length);
    ...
    makeInput: function(inputType, className, dataNum, optionsObj, dataName){
        ...
        if(inputType === "select"){
            var selectObj = {
                "name": lowerCaseName+dataNum,
                "id": className+dataNum,
    ...
    deleteCareFuncs: function (damNum, careNum) {
        this.runIfConfirmed(
            ...
            ()=>{
                ...
                if(index > -1){
                    this.dams[damNum].damCareNums.splice(index, 1);
                }
    ...
    addCare: function(damNum, careNum, date, changeFood, changeWater, changeBottom, changeTop){
        ...
        if(! inArray){
            // debugger;
            this.dams[damNum].damCareNums.push(careNum);
            this.dams[damNum].damCares[careNum] = {
                date: date,
                food: changeFood,
                water: changeWater,
                damBottom: changeBottom,
                damTop: changeTop
            };
        }
    },
