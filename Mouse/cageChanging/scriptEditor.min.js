...
;for(label of labels){var careVal=cageCare[label]
;if(true===careVal)careVal="T";else if(!careVal)careVal=""
;row.push(careVal)}
...
var val=$(e).text()
;if(console.log(val),"T"===val)$(e).addClass("careDone")
...
labels)){var val=cageCare[label]
;if(true===val)val="T";else if(!val)val=""
;row.push(val)}tableData.push(row)}}}
