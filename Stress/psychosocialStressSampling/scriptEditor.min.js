...
;if(this.initDynamicContent(parsedJson),
...
sampleNums:[1,2,3]};return JSON.stringify(output)
...
sampleNums:this.sampleNums};return dynamicContent
...
text:"Stress"}]},{label:"Delete:",type:"button",
