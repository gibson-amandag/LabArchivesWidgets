...
"data-image":imgNum
}).append("<option value=''>[Select]</option>"+"<option value='4x'>4x</option>"+"<option value='10x'>10x</option>"+"<option value='20x'>20x</option>"+"<option value='40x'>40x</option>"))).append(this.makeRow("Region",$("<input></input>",{
