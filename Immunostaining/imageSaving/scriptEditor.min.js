...
;for(var i=0;i<3;i++){
var channelSearch=this.channelSearch(i),fluor="",intensity,channelName
;switch(i){case 0:
fluor="488-GFP",intensity=25,channelName="AF488"
;break;case 1:
fluor="594-cFos",intensity=25,channelName="AF594"
;break;case 2:
fluor="DAPI",intensity=25,channelName="DAPI";break
;default:break}
$(".fluor"+channelSearch).val(fluor),$(".defIntensity"+channelSearch).val(intensity),
