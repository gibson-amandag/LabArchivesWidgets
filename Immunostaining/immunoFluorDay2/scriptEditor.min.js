...
;$("#numWashes1").val(numWashes1);var numWashes2=5
...
;this.addAntibodies(abNum)}var numWashes1=5
;if(parsedJson.numWashes1)numWashes1=parsedJson.numWashes1
...
this.resize()}),$(".watchTime").on("input",e=>{
...
}).each((i,e)=>{this.updateWashDataTimes($(e))
...
}),this.updateAllWatchTimes(),this.PBST1Calc(),this.PBST2Calc(),
this.secondaryAbSolnCalc(),this.resize()},
updateWashDataTimes:function($el){
var washDur=$el.val(),timeText=this.getTimeText(washDur),whichWash=$el.data("whichwash")
...
var myLeftCol4="col-6 col-md-4 col-lg-3 text-right",timeText=this.getTimeText($("#washDur"+whichWash).val()),printNum=washIndex+1
