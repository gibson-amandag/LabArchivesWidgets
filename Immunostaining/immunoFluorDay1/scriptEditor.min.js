...
}),this.blockingSolnCalc(),this.PBST1Calc(),this.PBST2Calc(),
this.primaryAbSolnCalc(),this.resize()},
resize:function(){
...
console.log(time),$elToFill.text(time.toLocaleTimeString())
...
;if(dilutionFactor>0)var dilutionVal=1/dilutionFactor,amountAb_mL=this.startVolOfDilutionCalc(dilutionVal,primaryVol),amountAb_uL=+(1e3*amountAb_mL).toFixed(2);else var amountAb_uL="[Enter dilution factor]"
...
}).append("<div class='"+myLeftCol+"'>Antibody dilution (1:x)</div>").append($("<div></div>",{
class:"col"}).append($("<input></input>",{
