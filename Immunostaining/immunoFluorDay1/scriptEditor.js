my_widget_script =
{
    ...
    setUpInitialState: function () {
        ...
        $('.myLeftCol2').addClass("col-12 col-sm-5 col-md-4 col-lg-5 text-left text-sm-right");
        ...
        $("#desiredPBSTBlockVol").on("change", (e)=>{
            var desiredFinalVol = $(e.currentTarget).val();
            var solns = this.blockingSolnCalc(desiredFinalVol);
    ...
    */
    ...
    blockingSolnCalc: function(desiredFinalVol, dilFractionNGS = 0.04, dilFractionTriton = 0.004){
        if(desiredFinalVol > 0){
