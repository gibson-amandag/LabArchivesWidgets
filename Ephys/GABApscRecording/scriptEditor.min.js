...
widgetData:testData,VCSeriesNums:[1,4,5]}
;return JSON.stringify(output)},
...
this.addVCseries()}),this.resize()},
VCSeriesNums:[],resize:function(){
...
if(this.VCSeriesNums.length>0)var lastSeries=this.VCSeriesNums[this.VCSeriesNums.length-1],seriesNum=lastSeries+1;else var seriesNum=1
...
;if(index>-1)this.VCSeriesNums.splice(index,1)
