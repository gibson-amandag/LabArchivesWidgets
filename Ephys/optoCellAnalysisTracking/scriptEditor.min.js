...
}else if("recordingType"==watch)if(val){
var newVal="";for(selection of val){
if(newVal)newVal+=";";newVal+=selection}val=newVal
}
...
})))).append(acqDataRow).append(locationRow).append(recTypeRow).append(passiveDateRow).append(passivesRow).append(evDetectDateRow).append(evConfirmDateRow).append(responseRow).append(incCellRow).append($("<div/>",{
...
"data-cell":cellNum}))
;var $thisRow=$cellTableBody.find(this.cellSearch(cellNum)),cells=["cell","acqData","cellLoc","recordingType","checkPassDate","passives","evDetectDate","evConfirmDate","responseToStim","incCell","excludeCell"]
;for(i in cells){
...
$(e).attr("multiple",true)}),this.resize()},
