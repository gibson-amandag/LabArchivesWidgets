...
cells:{1:{id:"20220227a",recType:["extracellular"]
},2:{id:"20220227b"},3:{id:"20220227c"},4:{
id:"20220227d"},5:{id:"20220227e"},6:{
id:"20220227f",recType:[]},7:{id:"20220227g",
recType:["currentClamp","voltageClamp"]}}}
;return JSON.stringify(output)},
...
;if(parsedJson.cellNums)for(var i=0;i<parsedJson.cellNums.length;i++){
var cell=parsedJson.cellNums[i]
;this.cellNums.push(cell),this.makeCellCard(cell)
}else this.cellNums=[]},
...
;if("checkbox"===$el.attr("type"))if($el.is(":checked"))val="Y";else val="N"
;if($(calcSearch).html(val),
cellNum)this.updateExclusion(cellNum)
...
label:"Extracellular Recording:",type:"checkbox",
className:"extracellRec"},currentClampRecObj={
label:"Current Clamp Recording:",type:"checkbox",
className:"currentClampRec"},voltageClampRecObj={
label:"Voltage Clamp Recording:",type:"checkbox",
className:"voltageClampRec"
},extracellularRow=this.makeRowFromObj(extracellularRecObj,cellNum),currentClampRow=this.makeRowFromObj(currentClampRecObj,cellNum),voltageClampRow=this.makeRowFromObj(voltageClampRecObj,cellNum),locationObj={
label:"Cell location:",type:"text",
className:"cellLoc"
},locationRow=this.makeRowFromObj(locationObj,cellNum),responseRow=this.makeCheckRow(row,col,"Responded to stim:","responseToStim",cellNum)
;$div.append($("<div/>",{
...
})))).append(acqDataRow).append(locationRow).append(extracellularRow).append(currentClampRow).append(voltageClampRow).append(passiveDateRow).append(passivesRow).append(evDetectDateRow).append(evConfirmDateRow).append(responseRow).append(incCellRow).append($("<div/>",{
...
"data-cell":cellNum}))
;var $thisRow=$cellTableBody.find(this.cellSearch(cellNum)),cells=["cell","acqData","cellLoc","extracellRec","currentClampRec","voltageClampRec","checkPassDate","passives","evDetectDate","evConfirmDate","responseToStim","incCell","excludeCell"]
;for(i in cells){
...
name:lowerCaseName+itemNum,id:className+itemNum,
class:className+" fullWidth watch",
"data-watch":className,"data-cell":itemNum
...
type:inputType,name:lowerCaseName+itemNum,
...
var $row=this.makeRow(obj.label,this.makeInput(obj.type,obj.className,itemNum,obj.optionsObj),obj.addRowClass)
;return $row},
