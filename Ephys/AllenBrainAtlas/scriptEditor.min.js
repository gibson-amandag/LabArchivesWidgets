...
58:576987593,59:576987553,47:576988793,
60:576987513},AVPV:{47:576988793,48:576987993,
49:576987953,50:576987913,51:576987873,
52:576987833,53:576987793,46:576988833,
54:576987753},ARC:{65:576987303,66:576987259,
67:576990261,68:576990221,69:576990181,
70:576990141,71:576990101,72:576990061,
73:576990020,74:576989980,75:576989940,
64:576987346,76:576989900},BNST:{48:576987993,
49:576987953,50:576987913,51:576987873,
52:576987833,53:576987793,54:576987753,
55:576987713,56:576987673,57:576987633,
58:576987593,59:576987553,47:576988793,
60:576987513},PVN:{58:576987593,59:576987553,
60:576987513,61:576987473,62:576987433,
63:576987387,64:576987346,65:576987303,
66:576987259,67:576990261,57:576987633,
68:576990221},CeA:{60:576987513,61:576987473,
62:576987433,63:576987387,64:576987346,
65:576987303,66:576987259,67:576990261,
68:576990221,69:576990181,70:576990141,
71:576990101,72:576990061,73:576990020,
74:576989980,59:576987553,75:576989940}},
...
cellID:"a",region:"POA",section:49,xPos:249,
yPos:285,imgPath:"testLoc/name.tif"},2:{
cellID:"b",region:"POA",section:51,xPos:270,
yPos:385,imgPath:"testLoc/name2.tif"}}}
;return JSON.stringify(output)},
...
if(parsedJson.cells){
for(cell in parsedJson.cells)this.addCellRow(cell,parsedJson.cells[cell])
...
var sections=this.sections[region],startSection=0,numSections=0
;for(section in sections){
if(1==numSections)startSection=section
;$section.append("<option value='"+section+"'>"+section+"</option>"),
numSections++}}
if(startSection>0)$section.val(startSection)
...
var cellObj={cellID:cellID,region:region,
section:section,xPos:xPos,yPos:yPos}
;this.cells[cellNum]=cellObj,this.addCellRow(cellNum,cellObj)
},addCellRow:function(cellNum,cellObj){
var imgPath=""
;if(cellObj.imgPath)imgPath=cellObj.imgPath
;$("#cellTable").find("tbody").append($("<tr></tr>",{
"data-cell":cellNum,class:"cellRow"
}).append($("<td></td>",{class:"removeCol"
}).append($("<input></input>",{type:"button",
"data-cell":cellNum,class:"showCell fullWidth",
value:"Show Cell",id:"showCell"+cellNum,
name:"showcell"+cellNum}).on("click",e=>{
this.showCell($(e.currentTarget).data("cell"))
}))).append("<td>"+cellObj.cellID+"</td>").append("<td>"+cellObj.region+"</td>").append("<td>"+cellObj.section+"</td>").append("<td class='hideCol'>"+cellObj.xPos+"</td>").append("<td class='hideCol'>"+cellObj.yPos+"</td>").append($("<td></td>",{
class:"imgPath","data-cell":cellNum
}).append(imgPath)).append($("<td></td>",{
class:"imgPathButton removeCol hideView",
"data-cell":cellNum}).append($("<input></input>",{
type:"button","data-cell":cellNum,
class:"addImgPath fullWidth disableOnView",
value:"Add/edit image file path",
id:"addImgPath"+cellNum,name:"addimgpath"+cellNum
}).on("click",e=>{
...
$("#ABI_div").on("click",e=>{console.log(e)
;var rect=e.currentTarget.getBoundingClientRect(),x=e.clientX-rect.left,y=e.clientY-rect.top,cellID=$("#cellName").val()
...
showCells:function(){this.hideCells()
;var cells=this.cells;for(cell in cells){
var region=cells[cell].region,section=cells[cell].section
;if(region==$("#region").val())if(section==$("#section").val()){
var cellID=cells[cell].cellID,xPos=cells[cell].xPos,yPos=cells[cell].yPos
;this.addDot(cell,cellID,xPos,yPos,$("#ABI_div"))}
}this.resize()},showCell:function(cellNum){
var cells=this.cells,region=cells[cellNum].region,section=cells[cellNum].section
;if(region)if(section){
$("#region").val(region),this.changeSectionList(region),$("#section").val(section),
this.changeSectionDisplay()
;var cellID=cells[cellNum].cellID,xPos=cells[cellNum].xPos,yPos=cells[cellNum].yPos
;this.addDot(cellNum,cellID,xPos,yPos,$("#ABI_div")),
this.resize()
;var img=document.getElementById("ABI_section")
;img.scrollIntoView()}},hideCells:function(){
$(".dot").remove()},
addDot:function(cellNum,cellID,xPos,yPos,el){
$(el).append($("<div></div>",{"data-cell":cellNum,
"data-cellid":cellID,class:"dot",
style:"left:"+xPos+"px; top:"+yPos+"px;"
}).on("mouseover",e=>{
var cellID=$(e.target).data("cellid"),cellNum=$(e.target).data("cell")
;$(".hoverInfo").text("").append("This is cell ").append($("<span></span>",{
class:"font-weight-bold"
}).append(cellID)),this.resize()
}).on("mouseout",e=>{
$(".hoverInfo").text("Hover over a cell to see its ID"),this.resize()
})),this.resize()},addImgPath:function(cellNum){
var cellSearch=this.cellSearch(cellNum),$path=$(".imgPath"+cellSearch),currentPath=$path.text()
;this.runBasedOnInput("Enter img path or link to slice image",path=>{
if(!path)path=currentPath
;$(".imgPath"+this.dataSearch("cell",cellNum)).text(path),
this.cells[cellNum].imgPath=path
},void 0,currentPath)},resize:function(){
...
;if(elForHeight)top=elForHeight.offsetTop+"px"
;console.log("defValue",defValue),bootbox.prompt({
title:thisTitle,callback:result=>{
functionToCall(result)},value:defValue
}),$(".modal-dialog").css("top",top)},
...
;console.log(cols);for(var j=0;j<cols.length;j++){
var cellText=cols[j].innerText;row.push(cellText)}
csv.push(row.join(","))}
...
;for(var rows=e.target.result.split("\n"),i=0;i<rows.length;i++){
var cells=rows[i].split(",")
;if(cells.length>0)for(var row=table.insertRow(-1),j=0;j<cells.length;j++){
...
;for(cell in console.log(cells),cells){
var cellInfo=cells[cell],isDup=this.checkIfCellIsDuplicate(cellInfo)
;if(!isDup){
if(this.cellNums.length>0)var lastCell=this.cellNums[this.cellNums.length-1],cellNum=lastCell+1;else var cellNum=1
;var inArray=this.checkInArray(cellNum,this.cellNums)
;if(!inArray)this.cellNums.push(cellNum),
this.cells[cellNum]=cellInfo,this.addCellRow(cellNum,cellInfo)
}$("#dvCSV").text("")}
}),reader.readAsText(fileUpload.files[0])
}else bootbox.alert("This browser does not support HTML5.");else bootbox.alert("Please upload a valid CSV file.")
},getCellsFromCSVTable:function(csv){
var rows=csv.split("\n")
;if(rows.length>0)for(var headings=rows[0].split(","),cellsInfo={},i=1;i<rows.length;i++){
var cells=rows[i].split(",");cellsInfo[i]={}
;for(var j=0;j<cells.length;j++){
var heading=headings[j]
;cellsInfo[i][heading]=cells[j]}}return cellsInfo
},checkIfCellIsDuplicate:function(cellInfo){
var cellID=cellInfo.cellID,isDup=0
;for(cell in this.cells){
var existingID=this.cells[cell].cellID
;if(cellID==existingID){
isDup=1,bootbox.alert("cellID "+cellID+" already exists in database")
;break}}return isDup}};