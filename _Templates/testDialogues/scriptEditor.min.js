...
$(".hideView").hide();else $("input[type='date']").each(function(){
...
$(this).html("<span class='hideView' style='color:blue'>#</span>"+$(this).html())
}),$(".requiredLab").each(function(){
$(this).html("<span class='hideView' style='color:red'>*</span>"+$(this).html())
...
console.log("this",this),console.log("event",e),
console.log("data",$(e.target).data("mouse")),
this.buttonPress(),this.dialogConfirm("Make a choice:",result=>{
if(result)this.printFunc("You chose OK");else this.printFunc("You canceled or closed the dialog")
},$(e.target))
}),$("#deleteButton").on("click",function(){
my_widget_script.runIfConfirmed("Do you want to run the function?",()=>{
my_widget_script.printFunc("pretend delete function")
}),my_widget_script.buttonPress()
}),$("#enterValButton").on("click",function(){
my_widget_script.buttonPress(),my_widget_script.runBasedOnInput("Enter a number from 0-10",result=>{
if(result<=10&&result>=0)my_widget_script.printFunc("You entered: "+result);else my_widget_script.printFunc("You did not enter an appropriate value")
})}),my_widget_script.resize()},
buttonPress:function(){
$(".printSpace").text("You clicked a button"),my_widget_script.resize()
},printFunc:function(text){
$(".printSpace").text(text),my_widget_script.resize()
...
functionToCall(result)}})},resize:function(){
